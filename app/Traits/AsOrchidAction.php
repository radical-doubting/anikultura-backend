...
trait AsOrchidAction
{
     ...
     */
    public static function runOrchidAction(Model $model, ?Request $request): RedirectResponse
    {
     ...
     */
    public function handleAsOrchidAction(Model $model, ?Request $request): RedirectResponse
    {
        if (isset($request)) {
